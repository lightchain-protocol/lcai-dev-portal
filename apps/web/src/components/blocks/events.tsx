	...
	return (
		<section className="py-10 md:py-20 xl:py-30">
			<div className="mx-auto max-w-335 px-4">
				<div className="w-full rounded-[32px] border-border-slate-soft md:border md:p-5">
					<div className="relative w-full overflow-hidden rounded-xl border border-border-slate-soft bg-surface-slate-medium px-4 py-4 md:rounded-[24px] md:px-6">
						<div
